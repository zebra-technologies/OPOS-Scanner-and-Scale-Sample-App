...
*
********************************************************************************************/
// TestScanDlg.cpp : implementation file
//
...
void CTestScanDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_UPDATE_EDIT, m_nGoodScanCount);
	//}}AFX_DATA_MAP
...
BEGIN_MESSAGE_MAP(CTestScanDlg, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_CLOSE_BUTTON, &CTestScanDlg::OnBnClickedCloseButton)
	ON_BN_CLICKED(IDC_CHECK_AutoEvtEnable, &CTestScanDlg::OnBnClickedCheckAutoevtenable)
	ON_CBN_SELCHANGE(IDC_COMBO_DIO_OpCodes, &CTestScanDlg::OnCbnSelchangeComboDioOpcodes)
	ON_BN_CLICKED(IDC_BUTTON_Execute, &CTestScanDlg::OnBnClickedButtonExecute)
...
BOOL CTestScanDlg::OnInitDialog()
{
	...
	#if defined(_WIN64)
		#define MY_CAPTION L"Scanner OPOS Test (64bit)"
	#else
		#define MY_CAPTION L"Scanner OPOS Test (32bit)"
	#endif
...
BEGIN_EVENTSINK_MAP(CTestScanDlg, CDialog)
	...
	ON_EVENT(CTestScanDlg, IDC_SCANNER1, 1 /* DataEvent */, OnDataEventScanner1, VTS_I4)
	//}}AFX_EVENTSINK_MAP
	ON_EVENT(CTestScanDlg, IDC_SCANNER1, 5, CTestScanDlg::StatusUpdateEventScanner1, VTS_I4)
END_EVENTSINK_MAP()

void CTestScanDlg::OnDataEventScanner1(long lStatus) 
{
	...
	//get the scan data
	m_editScanData.SetWindowText(strScanData);	
...
void CTestScanDlg::OnUpdateEdit(CCmdUI *pCmdUI)
{
	pCmdUI->Enable(m_bIsOpen);
}

void CTestScanDlg::OnButton1() 
{
	//enable the device
...
void CTestScanDlg::OnSelchangePropertiesCombo() 
{
    BOOL bValid=TRUE;
...
void CTestScanDlg::OnClaimButton() 
{
...
void CTestScanDlg::OnReleaseButton() 
{
...
void CTestScanDlg::OnLearInputButton() 
{
...
void CTestScanDlg::OnClearButton() 
{
...
void CTestScanDlg::OnDecodeButton() 
{
...
CString CTestScanDlg::GetScanDataType(long p_nLabelType)
{
...
void CTestScanDlg::OnRetrievButton() 
{
	CString strTemp1;
	strTemp1="M_";	

	BSTR  test=strTemp1.AllocSysString ();
...
void CTestScanDlg::OnResetStatButton() 
{
	long lRetVal = m_ctrlScanner.ResetStatistics(L"GoodScanCount");
	m_iScanCount = 0;
	UpdateState();
}

void CTestScanDlg::OnInputButton() 
{
	m_ctrlScanner.ClearInputProperties();
}

void CTestScanDlg::OnBnClickedCloseButton()
{
	// TODO: Add your control notification handler code here
}

void CTestScanDlg::OnBnClickedCheckAutoevtenable()
{
...
int CTestScanDlg::SetupDirectIO(void)
{
...
void CTestScanDlg::OnCbnSelchangeComboDioOpcodes()
{
	CComboBox* cmbDIOCommands = (CComboBox*)GetDlgItem(IDC_COMBO_DIO_OpCodes);
	m_pdioSelectedItem = (PDIO_OPCODES)cmbDIOCommands->GetItemDataPtr(cmbDIOCommands->GetCurSel());
...
void CTestScanDlg::OnBnClickedButtonExecute()
{
	LONG retVal;
	CString csInXML;
...
void CTestScanDlg::OnBnClickedButtonClear()
{
	CString empty(L"");
