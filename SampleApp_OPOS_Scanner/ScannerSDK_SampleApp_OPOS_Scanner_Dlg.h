...
*
********************************************************************************************/
// ScannerSDK_SampleApp_OPOS_Scanner_Dlg.h : header file
//
#include "Opos.h"
#include <vector>
/////////////////////////////////////////////////////////////////////
...
class CScannerSDK_SampleApp_OPOS_Scanner_Dlg : public CDialog
{
// Construction
public:
	short UpdateState();
	short LoadProtocolList();
	CScannerSDK_SampleApp_OPOS_Scanner_Dlg(CWnd* pParent = NULL);	// standard constructor
    short LoadPropertyList();
	CString GetErrorString( long lVal );
// Dialog Data
	//{{AFX_DATA(CScannerSDK_SampleApp_OPOS_Scanner_Dlg)
	enum { IDD = IDD_SCANNERSDK_SAMPLEAPP_OPOS_SCANNER_DIALOG };
	CComboBox	m_ctProp;
	...
	CString m_statisticsFilter; //SSDK-19840 - Implementing retrieve statistics filter
	//}}AFX_DATA

	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CScannerSDK_SampleApp_OPOS_Scanner_Dlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CScannerSDK_SampleApp_OPOS_Scanner_Dlg)
...
private:
	...
	CString CurrentTime();
	CString scannerProfile; //DNS-174
public:
	...
	afx_msg void OnEnChangeStatisticsFilter(); //SSDK-19840 - Implementing retrieve statistics filter
